...
(async()=>{
  ...
  try{
    ...
    check('selected story photos enlarged only where space allows',await page.evaluate(()=>document.querySelector('#pageAbout .photo-top').offsetHeight===340 && document.querySelector('#pageSolution .photo-top').offsetHeight===260 && document.querySelector('#pageScope .photo-top').offsetHeight===210));
